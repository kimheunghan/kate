...
<h1>주간 추진실적 보고</h1>
<table>
  <colgroup><col style="width:11%"><col style="width:8%"><col style="width:27%"><col style="width:27%"><col style="width:27%"></colgroup>
  <thead><tr>
    <th>기관명</th>
    <th>참여인력</th>
