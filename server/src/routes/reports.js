 ...
 *   작성자만 못 쓴다. 화면에서 작성만 하고 문서로 가져가지 않는다.
...
<h1>주간 추진실적 보고</h1>
<table>
  <colgroup><col style="width:12%"><col style="width:8%"><col style="width:25%"><col style="width:27.5%"><col style="width:27.5%"></colgroup>
  <thead><tr>
    <th>기관명</th>
    <th>참여인력</th>
...
router.get('/:id(\\d+)/export-hwpx', requireExport, async (req, res, next) => {
  try {
    ...
    // 기관명 12% / 참여인력 8% / 당초 25% / 실적 27.5% / 향후 27.5%
